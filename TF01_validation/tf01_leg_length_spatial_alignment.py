...
path_to_freemocap_recording_folder=Path(r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_55_21_TF01_leg_length_pos_5_trial_1")

paths = [
    r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_38_16_TF01_leg_length_neg_5_trial_1",
    r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_43_15_TF01_leg_length_neg_25_trial_1",
    r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_46_54_TF01_leg_length_neutral_trial_1",
    r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_50_56_TF01_leg_length_pos_25_trial_1",
    r"D:\2023-06-07_TF01\1.0_recordings\treadmill_calib\sesh_2023-06-07_12_55_21_TF01_leg_length_pos_5_trial_1"
]

for path in paths:
    path_to_freemocap_recording_folder = Path(path)
    output_data_folder = 'rigid_mediapipe_dlc_output_data'
    ...
    plot_3d_scatter(freemocap_data=aligned_freemocap_skeleton_model.marker_data_as_numpy,
                    qualisys_data=np.load(tf01_flex_neutral_config.path_to_qualisys_output_data))
    np.save(path_to_aligned_data_folder / 'mediapipe_body_3d_xyz.npy',
            aligned_freemocap_skeleton_model.original_marker_data_as_numpy)
