...
class JointAnglesStridesStep(ValidationStep):
    ...
    def calculate(self, condition_frame_range:list[int] = None):
        ...
        self.outputs[FREEMOCAP_JOINT_ANGLE_CYCLES.name] = split_ja_dfs[self.ctx.project_config.freemocap_tracker]
        self.outputs[QUALISYS_JOINT_ANGLE_CYCLES.name] = split_ja_dfs["qualisys"]
