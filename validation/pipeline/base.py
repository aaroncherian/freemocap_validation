...
if __name__ == "__main__":
    ...
    cfg_root_leg_length = Path(r"C:\Users\aaron\Documents\GitHub\freemocap_validation\config_yamls\prosthetic_data\leg_length")
    cfg_root_toe_in = Path(r"C:\Users\aaron\Documents\GitHub\freemocap_validation\config_yamls\prosthetic_data\toe_in")
    cfg_root_flexion = Path(r"C:\Users\aaron\Documents\GitHub\freemocap_validation\config_yamls\prosthetic_data\flexion")
    
    list_cfg = [
        cfg_root_leg_length / "leg_length_neg5.yaml",
        cfg_root_leg_length / "leg_length_neg25.yaml",
        cfg_root_leg_length / "leg_length_neutral.yaml",
        cfg_root_leg_length / "leg_length_pos25.yaml",
        cfg_root_leg_length / "leg_length_pos5.yaml",
        cfg_root_toe_in / "toe_neg_6.yaml",
        cfg_root_toe_in / "toe_neg_3.yaml",
        cfg_root_toe_in / "toe_neutral.yaml",
        cfg_root_toe_in / "toe_pos_3.yaml",
        cfg_root_toe_in / "toe_pos_6.yaml",
        cfg_root_flexion / "flexion_neg_5_6.yaml",
        cfg_root_flexion / "flexion_neg_2_8.yaml",
        cfg_root_flexion / "flexion_neutral.yaml",
        cfg_root_flexion / "flexion_pos_2_8.yaml",
