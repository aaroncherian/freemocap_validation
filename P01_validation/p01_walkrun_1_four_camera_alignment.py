...
import numpy as np
from skellymodels.create_model_skeleton import create_rigid_mediapipe_skeleton_model, create_qualisys_skeleton_model

path_to_freemocap_recording_folder= Path(r'D:\2024-04-25_P01\1.0_recordings\P01_WalkRun_Trial1_four_cameras')
...
p01_walkrun_trial_1_alignment_config = SpatialAlignmentConfig(
    ...
    path_to_freemocap_output_data = path_to_freemocap_recording_folder/'output_data'/'mediapipe_body_3d_xyz_rigid.npy',
    freemocap_skeleton_function = create_rigid_mediapipe_skeleton_model,
...
if __name__ == '__main__':
    ...
    plot_3d_scatter(freemocap_data=aligned_freemocap_skeleton_model.marker_data_as_numpy[:,0:33,:], qualisys_data= np.load(p01_walkrun_trial_1_alignment_config.path_to_qualisys_output_data))
    np.save(path_to_aligned_data_folder/'mediapipe_body_3d_xyz.npy', aligned_freemocap_skeleton_model.original_marker_data_as_numpy[:,0:33,:])
