...
p01_nih_rigid_alignment_config = SpatialAlignmentConfig(
    path_to_freemocap_recording_folder=path_to_freemocap_recording_folder,
...
if __name__ == '__main__':
    ...
    np.save(path_to_aligned_data_folder/'mediapipe_body_3d_xyz_rigid.npy', aligned_freemocap_skeleton_model.original_marker_data_as_numpy)
