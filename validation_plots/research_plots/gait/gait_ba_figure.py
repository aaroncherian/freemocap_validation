"""
Bland-Altman figure: Stride Duration + Stride Length across three trackers, colored by speed.

Side-by-side two-column figure for main results section.
"""
...
# ------------------------------------------------------------------
# Config — two metrics side by side
# ------------------------------------------------------------------
METRICS = [
    {
        "key": "stride_duration",
